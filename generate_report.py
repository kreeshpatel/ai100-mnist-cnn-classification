...
def build_report():
    ...
    pdf.body_text(
        ...
        "hyperparameters, interpreted the results, and drew the conclusions discussed throughout "
        "this document. The project structure, implementation decisions, and all observations "
        "reflect my personal understanding of the material covered in the AI 100 course."
    )

    pdf.body_text(
        "The coding and implementation part of this project was fully done by Claude (an AI "
        "assistant by Anthropic). This includes the training and evaluation code, utility "
        "functions, and the overall code structure. Additionally, after drafting the content "
        "of this report, I used Claude to help rewrite and polish the language for clarity, "
        "grammar, and overall readability. All ideas, technical decisions, analysis, and "
        "conclusions remain entirely my own."
    )
